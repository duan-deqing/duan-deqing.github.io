      ...
      >
        <div className="h-16 px-6 md:px-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              [<span className="nav-link-text">{t(contactPage.backToHome)}</span>]
            </Link>
